...
export default function InsigniaConfianza({ fechaUltimaRevision }: { fechaUltimaRevision: string }) {
  return (
    <div className="inline-flex items-center gap-3 rounded-2xl border border-slate-200/80 bg-white px-4 py-3 shadow-[0_1px_2px_rgba(15,23,42,0.04)] ring-1 ring-contorno">
