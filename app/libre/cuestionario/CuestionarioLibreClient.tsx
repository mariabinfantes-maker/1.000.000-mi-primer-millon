 ...
 *
 * Extraído de `page.tsx` (que se queda como Server Component) porque un
 * archivo `"use client"` no puede exportar `metadata`/`generateMetadata`.
 */
export default function CuestionarioLibreClient() {
