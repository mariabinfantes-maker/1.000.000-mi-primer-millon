 ...
 * no su nombre. Estas pruebas fijan lo que se encontró, incluidos los cinco
 * casos en los que el nombre engañaba.
 */
describe("cada tarea declara qué argumentos admite", () => {
  ...
  /** Los cinco casos que sólo se ven leyendo el `argv`. */
