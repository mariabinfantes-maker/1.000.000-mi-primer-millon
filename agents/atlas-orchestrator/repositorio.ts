 ...
 *
 * Guardar las solicitudes en `data/`, como ficheros, parecía lo natural y
 * no sirve: la máquina donde corre el orquestador y la web donde la
 * propietaria firmará no comparten disco, y el sistema de ficheros de
 * Vercel es efímero. Una autorización firmada en la web no llegaría nunca
 * al ejecutor. Postgres es el único sitio que los dos ven.
 *
