...
describe("enlaceEsUsable", () => {
  it("acepta un enlace de afiliada real, con parámetros y fragmento", () => {
    ...
    expect(enlaceEsUsable("https://proveedor.test/tr/00000/00000000000/00000000/0000000000000000000000000000000000000000")).toBe(true);
  });
  ...
  it("rechaza el enlace pegado a medias que se vio en producción", () => {
    ...
    expect(enlaceEsUsable("ps://proveedor.test/tr/00000/00000000000")).toBe(false);
    expect(enlaceEsUsable("tps://proveedor.test/tr/00000")).toBe(false);
    expect(enlaceEsUsable("//proveedor.test/tr/00000")).toBe(false);
  });
...
describe("puedeActivarse", () => {
  ...
  it("tampoco con un enlace que no serviría", () => {
    expect(puedeActivarse("ps://proveedor.test/tr/00000")).toBe(false);
  });

  it("con un enlace utilizable, sí", () => {
    expect(puedeActivarse("https://proveedor.test/tr/00000/00000000000")).toBe(true);
  });
});
